        ...
        <div style={{ position: 'relative', width: '100%' }} ref={ref}>
            <button
                ...
                style={{
                    ...
                    border: `1.5px solid ${open ? '#0D9488' : 'rgba(0,0,0,0.1)'}`,
                    borderRadius: 10,
                            ...
                            return (
                                <button
                                    ...
                                    onMouseLeave={e => {
                                        if (cell.cur && !sel) {
                                            const b = e.currentTarget as HTMLButtonElement;
                                            b.style.background = tod ? '#F0FDFA' : 'transparent';
                                            b.style.color = tod ? '#0D9488' : '#111827';
                                        }
                                    }}
                                >
                                    {cell.day}
    ...
    return (
        ...
        <style>{`
            ...
            .rp-hero-back {
                ...
                text-decoration:none; margin-bottom:22px; transition:all .18s;
                font-family:"DM Sans",sans-serif;
            }
            .rp-hero-back:hover { background:rgba(255,255,255,0.1); color:#fff; }
            .rp-hero-badge {
                display:inline-flex; align-items:center; gap:6px; padding:5px 12px;
                border-radius:100px; border:1px solid rgba(29,158,117,0.4);
                background:rgba(29,158,117,0.12); font-size:10px; font-weight:800;
                letter-spacing:2px; text-transform:uppercase; color:#6EE7B7; margin-bottom:14px;
            }
            ...
            .rp-tabs {
                ...
                border-radius:14px; margin-bottom:20px; overflow-x:auto;
            ...
            .rp-radio-opt,.rp-check-opt {
                ...
                padding:10px 14px; border-radius:10px; border:1px solid rgba(0,0,0,0.07);
            ...
            .rp-actions {
                ...
                padding:14px 52px; display:flex; align-items:center; justify-content:flex-end; gap:10px;
                box-shadow:0 -4px 24px rgba(0,0,0,0.08);
            }
            .rp-btn-cancel {
                height:44px; padding:0 22px; border:1.5px solid rgba(0,0,0,0.1);
                border-radius:10px; background:#F9FAFB; font-family:"DM Sans",sans-serif;
                font-size:13.5px; font-weight:600; color:#6B7280; cursor:pointer; transition:all .18s;
            }
            .rp-btn-cancel:hover { background:#F1F5F9; color:#374151; }
            .rp-btn-draft {
                height:44px; padding:0 22px; border:1.5px solid rgba(13,148,136,0.3);
                border-radius:10px; background:#F0FDFA; font-family:"DM Sans",sans-serif;
                font-size:13.5px; font-weight:700; color:#0D9488; cursor:pointer; transition:all .18s;
            }
            ...
            .rp-btn-submit {
                ...
                font-size:13.5px; font-weight:700; color:#fff; cursor:pointer; transition:all .22s;
        ...
        <div className="rp-wrap">
            ...
            <div className="rp-hero">
                ...
                <div className="rp-hero-inner">
                    ...
                    <div className="rp-hero-pills">
                        {[
                            { val:'5 Clinical Tabs', lbl:'Sections' },
                            { val:'TNM Staging',     lbl:'AJCC 8th Ed' },
                            { val:'Auto Draft',      lbl:'Save Anytime' },
                        ].map(p => (
                ...
                <div className="rp-card">
                    ...
                    <div className="rp-patient-grid">
                        <div className="rp-fgroup">
                            ...
                            <input className="rp-input" type="text" placeholder="Enter patient name" value={patientName} onChange={e => setPatientName(e.target.value)} />
                        </div>
                        <div className="rp-fgroup">
                            <label className="rp-label">Patient ID *</label>
                            <input className="rp-input" type="text" placeholder="Enter patient ID" value={patientId} onChange={e => setPatientId(e.target.value)} />
                        </div>
                        <div className="rp-fgroup">
                    ...
                    <div className="rp-section">
                        ...
                        <div className="rp-card">
                            ...
                            <div className="rp-grid5">
                                <div className="rp-fgroup">
                                    <label className="rp-label">Composition</label>
                                    <select className="rp-select" value={usComposition} onChange={e => setUsComposition(e.target.value)}>
                                        <option>Cystic</option><option>Spongiform</option><option>Mixed</option><option>Solid</option>
                                    </select>
                                </div>
                                <div className="rp-fgroup">
                                    <label className="rp-label">Echogenicity</label>
                                    <select className="rp-select" value={usEchogenicity} onChange={e => setUsEchogenicity(e.target.value)}>
                                        <option>Anechoic</option><option>Hyperechoic</option><option>Isoechoic</option><option>Hypoechoic</option>
                                    </select>
                                </div>
                                <div className="rp-fgroup">
                                    <label className="rp-label">Shape</label>
                                    <select className="rp-select" value={usShape} onChange={e => setUsShape(e.target.value)}>
                                        <option>Wider-than-tall</option><option>Taller-than-wide</option>
                                    </select>
                                </div>
                                <div className="rp-fgroup">
                                    <label className="rp-label">Margin</label>
                                    <select className="rp-select" value={usMargin} onChange={e => setUsMargin(e.target.value)}>
                                        <option>Smooth</option><option>Ill-defined</option><option>Lobulated</option><option>Irregular</option>
                                    </select>
                                </div>
                                <div className="rp-fgroup">
                                    <label className="rp-label">TI-RADS Score</label>
                                    <input className="rp-input" type="text" placeholder="e.g., TR3, TR4" value={tiradsScore} onChange={e => setTiradsScore(e.target.value)} />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="rp-section">
                        <div className="rp-card">
                            ...
                            <div className="rp-grid-tnm">
                                <div className="rp-fgroup">
                                    <p className="rp-tnm-cat-label">T — Primary Tumor</p>
                                    <select className="rp-select" value={tCategory} onChange={e => setTCategory(e.target.value)}>
                                ...
                                <div className="rp-fgroup">
                                    <p className="rp-tnm-cat-label">N — Lymph Nodes</p>
                                    <select className="rp-select" value={nCategory} onChange={e => setNCategory(e.target.value)}>
                                ...
                                <div className="rp-fgroup">
                                    <p className="rp-tnm-cat-label">M — Metastasis</p>
                                    <select className="rp-select" value={mCategory} onChange={e => setMCategory(e.target.value)}>
                                ...
                                <div className="rp-fgroup">
                                    <p className="rp-tnm-cat-label">Metastasis Sites</p>
                                    <div className="rp-check-group">
                                        {['Lung','Bone','Brain','Liver'].map(s => (
                                            <label key={s} className="rp-check-opt">
                                ...
                                <div className="rp-fgroup">
                                    <p className="rp-tnm-cat-label">Stage Group</p>
                                    <select className="rp-select" value={stageGroup} onChange={e => setStageGroup(e.target.value)}>
                                ...
                                <div className="rp-fgroup">
                                    <p className="rp-tnm-cat-label">ATA Risk</p>
                                    <select className="rp-select" value={ataRisk} onChange={e => setAtaRisk(e.target.value)}>
                ...
                {activeTab === 'molecular' && (
                    <div className="rp-section">
                        ...
                        <div className="rp-card">
                            ...
                            <div className="rp-grid3">
                                <div className="rp-fgroup">
                                    <label className="rp-label">Tg (Thyroglobulin)</label>
                                    <input className="rp-input" type="number" placeholder="ng/mL" value={tgLevel} onChange={e => setTgLevel(e.target.value)} />
                                </div>
                                <div className="rp-fgroup">
                                    <label className="rp-label">Anti-Tg Antibodies</label>
                                    <input className="rp-input" type="number" placeholder="IU/mL" value={antiTg} onChange={e => setAntiTg(e.target.value)} />
                                </div>
                                <div className="rp-fgroup">
                                    <label className="rp-label">Calcitonin</label>
                                    <input className="rp-input" type="number" placeholder="pg/mL" value={calcitonin} onChange={e => setCalcitonin(e.target.value)} />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="rp-section">
                        ...
                        <div className="rp-card">
                            ...
                            <div className="rp-grid2">
                                <div className="rp-fgroup">
                                    <label className="rp-label">RAI Dose (mCi)</label>
                                    <input className="rp-input" type="number" placeholder="e.g., 30, 100" value={raiDose} onChange={e => setRaiDose(e.target.value)} />
                                </div>
                                <div className="rp-fgroup">
                                    <label className="rp-label">Date of RAI</label>
                        ...
                        <div className="rp-card">
                            ...
                            <div className="rp-grid2">
                                <div className="rp-fgroup">
                                    <label className="rp-label">Next visit</label>
                                    <DatePicker value={nextVisit} onChange={setNextVisit} placeholder="Select date" />
                                </div>
                                <div className="rp-fgroup">
                                    <label className="rp-label">Next Tg check</label>
            ...
            <div className="rp-actions">
                ...
                <button className="rp-btn-draft" onClick={handleSaveDraft} disabled={loading}>
